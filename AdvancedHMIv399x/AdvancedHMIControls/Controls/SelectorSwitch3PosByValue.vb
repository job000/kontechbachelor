...
Public Class SelectorSwitch3PosByValue
...
#Region "Events"
    ...
    Private Sub ClickedLeft() Handles MyBase.SwitchLeft
        Try
            If (Not String.IsNullOrEmpty(m_PLCAddressValue)) Then
                m_ComComponent.Write(m_PLCAddressValue, ValueOfLeftPosition)
            End If
    ...
    Private Sub ClickedCenter() Handles MyBase.SwitchCenter
        Try
            If (Not String.IsNullOrEmpty(m_PLCAddressValue)) Then
                m_ComComponent.Write(m_PLCAddressValue, ValueOfCenterPosition)
            End If
        Catch ex As Exception
            DisplayError("WRITE FAILED!" & ex.Message)
        End Try
    ...
    Private Sub ClickedRight() Handles MyBase.SwitchRight
        Try
            If (Not String.IsNullOrEmpty(m_PLCAddressValue)) Then
                m_ComComponent.Write(m_PLCAddressValue, ValueOfRightPosition)
            End If
        Catch ex As Exception
            DisplayError("WRITE FAILED!" & ex.Message)
        End Try
