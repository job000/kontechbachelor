...
'****************************************************************************
Public Class RotationalIndicator
    Inherits MfgControl.AdvancedHMI.Controls.RotationalPositionIndicator
...
#Region "PLC Related Properties"
    ...
    '* Property - Address in PLC to Link to
    '*****************************************
    Private m_PLCAddressTargetValue As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
    <System.ComponentModel.DefaultValue("")> _
    <System.ComponentModel.Category("PLC Properties")> _
    Public Property PLCAddressTargetValue() As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
        Get
            Return m_PLCAddressTargetValue
        End Get
        Set(ByVal value As MfgControl.AdvancedHMI.Drivers.PLCAddressItem)
            If m_PLCAddressTargetValue IsNot value Then
    ...
    '* Property - Address in PLC to Link to
    '*****************************************
    Private m_PLCAddressTargetValueTolerance As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
    <System.ComponentModel.DefaultValue("")> _
    <System.ComponentModel.Category("PLC Properties")> _
    Public Property PLCAddressTargetValueTolerance() As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
        Get
            Return m_PLCAddressTargetValueTolerance
        End Get
        Set(ByVal value As MfgControl.AdvancedHMI.Drivers.PLCAddressItem)
            If m_PLCAddressTargetValueTolerance IsNot value Then
    ...
    '* Property - Address in PLC to Link to
    '*****************************************
    Private m_PLCAddressTarget2Value As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
    <System.ComponentModel.DefaultValue("")> _
    <System.ComponentModel.Category("PLC Properties")> _
    Public Property PLCAddressTarget2Value() As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
        Get
            Return m_PLCAddressTarget2Value
        End Get
        Set(ByVal value As MfgControl.AdvancedHMI.Drivers.PLCAddressItem)
            If m_PLCAddressTarget2Value IsNot value Then
    ...
    '* Property - Address in PLC to Link to
    '*****************************************
    Private m_PLCAddressShowTargetBands As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
    <System.ComponentModel.DefaultValue("")> _
    <System.ComponentModel.Category("PLC Properties")> _
    Public Property PLCAddressShowTargetBands() As MfgControl.AdvancedHMI.Drivers.PLCAddressItem
        Get
            Return m_PLCAddressShowTargetBands
        End Get
        Set(ByVal value As MfgControl.AdvancedHMI.Drivers.PLCAddressItem)
            If m_PLCAddressShowTargetBands IsNot value Then
