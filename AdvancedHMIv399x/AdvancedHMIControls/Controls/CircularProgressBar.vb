...
'* Based on contribution by James Landerwin
'*
...
Public Class CircularProgressBar
    Inherits MfgControl.AdvancedHMI.Controls.CircularProgressBar
...
#Region "Constructor/Destructor"
    ...
    Protected Overrides Sub dispose(disposing As Boolean)
        Try
            If disposing Then
                If SubScriptions IsNot Nothing Then
                    RemoveHandler SubScriptions.DisplayError, AddressOf DisplaySubscribeError
    ...
    Public Sub EndInit() Implements System.ComponentModel.ISupportInitialize.EndInit
        If Not Me.DesignMode Then
            If Not String.IsNullOrEmpty(m_IniFileName) Then
                Try
                    AdvancedHMIDrivers.Utilities.SetPropertiesByIniFile(Me, m_IniFileName, m_IniFileSection)
